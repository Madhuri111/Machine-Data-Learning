...
while(1):
    ...
    for i in range(12,60,1):
        ...
        for j in range(60):
            ...
            a=a+0.1*act1[i][j]*prev_util[j]  #for shoot action

            b=b+0.1*act2[i][j]*prev_util[j]  #for dodge action

            c=c+0.1*act3[i][j]*prev_util[j]  #for recharge action
